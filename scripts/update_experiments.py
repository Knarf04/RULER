...
def update_experiments_config(config_path, updates):
    """
    Loads a JSON config, ensures an 'experiments' field exists,
    updates multiple key-value pairs within it, and saves the file.

    Args:
        config_path (str): The path to the config.json file.
        updates (dict): A dictionary of key-value pairs to add or update
                        within the 'experiments' dictionary.
    """
